...
class DBClient:
    ...
    def __init__(self):
        ...
        try:
            client = pymongo.MongoClient('mongodb+srv://home-automation.mplvx.mongodb.net/?retryWrites=true&w=majority', username='mababio',password='mongodb' ,server_api=ServerApi('1'))
